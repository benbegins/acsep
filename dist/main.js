...
})({"lMBWf":[function(require,module,exports) {
"use strict";
...
const menu = ()=>{
    ...
    btnsSub.forEach((btn)=>{
        btn.addEventListener("click", ()=>{
            ...
            if (submenu.classList.contains("submenu") && !submenu.classList.contains("active")) openSubmenu(submenu, btn);
            else closeSubmenus();
        });
    });
    ...
    window.addEventListener("scroll", (e)=>{
        if (window.scrollY > 100) mainNavBackground(true);
        else mainNavBackground(false);
    });
    // Functions
    const closeSubmenus = ()=>{
        allowScroll(true);
        ...
        if (window.scrollY < 100) mainNavBackground(false);
    };
    ...
    const mainNavBackground = (state)=>{
        if (state) mainNav.classList.add("is-scrolling");
        else mainNav.classList.remove("is-scrolling");
    };
    const allowScroll = (state)=>{
        if (state) {
            body.classList.remove("overflow-hidden");
            (0, _lenisDefault.default).start();
        } else {
            body.classList.add("overflow-hidden");
            (0, _lenisDefault.default).stop();
        }
    };
};
...
},{}],"ds5Ep":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"gljYa","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"agGoQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var l = [
    ...
    function l(i) {
        ...
        (s = t.call(this) || this).onWindowResize = function() {
            ...
            var e = t.deltaY, i = t.deltaX, o = t.originalEvent, r = !!o.composedPath().find(function(t) {
        ...
        }, window.lenisVersion = "0.2.26", s.options = {
            duration: h,
            easing: u,
            smooth: f,
            mouseMultiplier: w,
        ...
        return s.virtualScroll = new (0, _virtualScrollDefault.default)({
            ...
            mouseMultiplier: s.mouseMultiplier * (H.includes("Win") || H.includes("Linux") ? .84 : .4),
...
},{"tiny-emitter":"hX1Zp","virtual-scroll":"8LkE0","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"hX1Zp":[function(require,module,exports) {
function E() {
...
},{}],"8LkE0":[function(require,module,exports) {
!function(e, t) {
    module.exports = t();
}(this, function() {
    var e = 0;
...
},{}],"f3zS5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// import Swiper JS
...
const sliders = ()=>{
    const sliderServices = new (0, _swiperDefault.default)(".slider-services", {
        modules: [
    ...
    const sliderSolutions = new (0, _swiperDefault.default)(".slider-solutions", {
        modules: [
            (0, _swiper.Navigation)
        ],
        spaceBetween: 24,
    ...
    const sliderActualites = new (0, _swiperDefault.default)(".slider-actualites", {
        spaceBetween: 24,
        speed: 400,
        slidesPerView: 1.1,
        breakpoints: {
    ...
    const sliderTemoignages = new (0, _swiperDefault.default)(".slider-temoignages", {
        modules: [
            (0, _swiper.Navigation)
        ],
        spaceBetween: 24,
...
},{"../../shared/create-shadow.js":"hlJwE","../../shared/effect-init.js":"TURXR","../../shared/effect-target.js":"76dEO","../../shared/effect-virtual-transition-end.js":"86Sfl","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"ibMwU":[function() {},{}],"kqbuQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const faq = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"gIqf1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
...
const animations = ()=>{
    ...
    if (fadeElements) fadeElements.forEach((element)=>{
        ...
        let translate;
        let duration;
        element.dataset.delay ? delay = element.dataset.delay : delay = 0;
        element.dataset.translate ? translate = element.dataset.translate * 20 : translate = 0;
        element.dataset.duration ? duration = element.dataset.duration : duration = 1;
...
},{"gsap":"33IqQ","gsap/ScrollTrigger":"5ubnS","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"5ubnS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["lMBWf","lFcwH"], "lFcwH", "parcelRequire4e91")
