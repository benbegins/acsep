...
<div class="pb-section-mobile lg:pb-section">
    <section class="section-actualite-du-moment relative pb-section-mobile md:pb-0 text-light">
        <div class="container">
            <div class="section-actualite-du-moment__content relative md:grid md:grid-cols-2 md:gap-8 md:rounded-2xl md:items-center">
                <div class="relative -top-5 rounded-xl md:rounded-2xl overflow-hidden md:left-5 md:min-h-[30vw] md:h-full"><?php echo wp_get_attachment_image($featured_article_image_id, 'medium_large', false, array('class'=>'w-full md:h-full md:absolute md:object-cover')); ?></div>
